    ...
    var body: some View {
        List {
            Section("Connection") {
                ...
                DebugRow(label: "Session ID", value: SignalRService.shared.sessionId ?? "None")
            }
    ...
    var body: some View {
        List {
            Section("Queue Status") {
                ...
                DebugRow(label: "Played URLs Count", value: "\(viewModel.playedAudioUrls.count)")
            }
...
// Extension to VoiceChatViewModel for debug access
extension VoiceChatViewModel {
    var playedAudioUrls: Set<String> {
        // This would be exposed from the actual implementation
        return []
    }
...
// Make SignalRService expose sessionId
extension SignalRService {
    var sessionId: String? {
        // This would be properly implemented in the service
        return "ios-session-debug"
    }
}
